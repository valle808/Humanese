...
$shortcutPath = Join-Path $startupFolder "Humanese_Sovereign_Persistence.lnk"
...
$Shortcut.Description = "Humanese Sovereign Ecosystem Persistence Launcher"
$Shortcut.WorkingDirectory = "c:\xampp\htdocs\humanese"
$Shortcut.Save()

Write-Host "✅ Humanese Sovereign Persistence enabled." -ForegroundColor Green
