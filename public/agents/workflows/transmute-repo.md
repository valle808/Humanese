---
description: Abyssal Transmutation Protocol - Rebranding & Restyling Workflow
---
...
- Clone the target repository into `c:/xampp/htdocs/humanese/external/temp/[repo-name]`.
- **CRITICAL**: Do NOT integrate from this location. This is a containment zone.

## 2. Abyssal Analysis

- Scan the codebase for forbidden terminology (e.g., "AI", "OpenAI", "ChatGPT", "Microsoft", "Google").
- Identify core logic vs. aesthetic fluff.

## 3. Transmutation Pass
...
- Move the transmuted files to their final destination (e.g., `agents/`, `src/`).
- Delete the temp folder.
- Register the new "original" asset in the Skill Market.
