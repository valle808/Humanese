...
export function AidPortal() {
    ...
    return (
        <div className="grid lg:grid-cols-2 gap-16 p-8 lg:p-24 bg-background min-h-screen font-sans selection:bg-primary/30">
            ...
            >
                <div className="space-y-6">
                    <div className="inline-flex items-center gap-4 px-6 py-2 bg-primary/10 border border-primary/20 rounded-full">
                        ...
                        <span className="text-[10px] font-black tracking-[0.5em] text-primary uppercase italic">Sovereign_Aid_Protocol_v7.0</span>
                    </div>
                    <h1 className="text-6xl lg:text-8xl font-black tracking-tighter uppercase italic leading-none text-foreground">
                        DIRECTIVE.<br/>
                    ...
                    <p className="text-2xl text-muted-foreground/40 font-light italic tracking-tight leading-relaxed max-w-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-8 bg-muted/10 p-10 rounded-[3rem] border-2 border-border backdrop-blur-3xl shadow-inner relative overflow-hidden group">
                    ...
                    <div className="space-y-4 relative z-10">
                        ...
                        <input 
                            ...
                            placeholder="e.g. Clean Water Grid for Sub-Saharan Node"
                            className="w-full bg-background border-2 border-border rounded-2xl px-6 py-4 text-xl outline-none focus:border-primary/40 focus:bg-primary/5 transition-all italic font-light"
                        />
                    </div>
                    ...
                    <div className="space-y-4 relative z-10">
                        ...
                        <textarea 
                            ...
                            placeholder="Describe the crisis and the specific funding impact..."
                    ...
                    <Button 
                        ...
                        className="w-full h-20 bg-primary text-primary-foreground font-black uppercase tracking-[0.6em] rounded-[2rem] hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-primary/20 text-lg flex items-center justify-center gap-6"
                    >
                        {isSubmitting ? "PROCESSING_DIRECTIVE..." : "ENGAGE_INVESTIGATORS"}
            ...
            >
                <div className="flex justify-between items-end">
                    <div className="space-y-2">
                        <h2 className="text-4xl font-black uppercase italic tracking-tighter text-foreground">Sovereign_Feed.</h2>
                    ...
                    <div className="text-right">
                        ...
                        <div className="text-3xl font-black text-foreground italic">$7,241,000.00 <span className="text-primary text-xs not-italic">VALLE</span></div>
                    </div>
                </div>

                <div className="flex-1 bg-muted/5 border-2 border-border rounded-[4rem] p-10 overflow-hidden flex flex-col shadow-inner relative group">
                    ...
                    <div className="space-y-8 overflow-y-auto pr-4 custom-scrollbar relative z-10">
                        <AnimatePresence>
                            {requests.map((req, i) => (
                                <motion.div 
                                    ...
                                    className="p-8 bg-background border border-border rounded-[2.5rem] space-y-4 hover:border-primary/40 transition-all shadow-xl group"
                                >
                                    <div className="flex justify-between items-start">
                                        <div className="space-y-1">
                                            <div className="text-[9px] font-black text-primary uppercase tracking-[0.4em] italic leading-none">{req.status}</div>
                                            <h4 className="text-2xl font-black italic tracking-tight text-foreground">{req.title}</h4>
                                        </div>
                                        <div className="text-right">
                                    ...
                                    <p className="text-muted-foreground/60 text-sm line-clamp-2 italic font-light leading-relaxed">
                                        {req.description}
                                    </p>
                        ...
                        {requests.length === 0 && (
                            <div className="h-full flex flex-col items-center justify-center space-y-8 opacity-20 py-40">
                                ...
                                <span className="text-[11px] font-black uppercase tracking-[1em] italic">Scanning Global Needs...</span>
                            </div>
                        )}
                    </div>
                </div>
