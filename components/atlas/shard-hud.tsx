         ...
         <div className="space-y-6 pb-8">
            ...
            <div className="space-y-4">
               {['Central_Identity', 'Matrix_Core', 'Swarm_Node'].map((ass, i) => (
                 <div key={i} className="flex items-center justify-between p-6 bg-muted/30 border-2 border-border rounded-[1.8rem] hover:bg-primary/5 hover:border-primary/20 transition-all cursor-pointer group shadow-inner">
