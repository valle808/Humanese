  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground selection:bg-primary/40 font-sans overflow-x-hidden pb-40">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-[80vw] h-[80vw] bg-primary/3 blur-[200px] rounded-full" />
      ...
      <main className="relative z-10 max-w-[1700px] mx-auto px-8 pt-24 lg:pt-32 space-y-32">
        ...
        >
            <div className="inline-flex items-center gap-4 px-6 py-2.5 bg-muted/10 border border-border rounded-full backdrop-blur-3xl">
               ...
               <span className="text-[11px] font-black tracking-[0.6em] text-primary uppercase italic leading-none">Sovereign Intervention Mandate</span>
            </div>
        ...
        <section className="grid lg:grid-cols-12 gap-24 items-start">
            ...
            <div className="lg:col-span-4 space-y-16 sticky top-32">
               <div className="p-16 border border-border bg-background/60 backdrop-blur-3xl space-y-16 shadow-[0_60px_100px_rgba(0,0,0,0.95)] relative overflow-hidden group rounded-[5rem]">
                  ...
                  <div className="pt-12 border-t border-border space-y-6 relative z-10">
                     <p className="text-[11px] text-muted-foreground/20 font-black uppercase tracking-[0.2em] italic leading-relaxed">
               ...
               <Link href="/aid" className="group flex justify-between items-center p-8 md:p-12 bg-muted/10 border border-border responsive-rounded hover:border-primary/40 hover:bg-primary/5 transition-all backdrop-blur-3xl shadow-2xl active:scale-95">
                  <div className="space-y-3">
                    <div className="text-[12px] font-black text-primary uppercase tracking-[0.4em] italic leading-none animate-pulse">Are you in need?</div>
                    <div className="text-4xl font-black uppercase italic tracking-tighter leading-none text-muted-foreground/80 group-hover:text-foreground transition-colors">Apply for Aid →</div>
                  </div>
                  <div className="h-20 w-20 rounded-[2.5rem] bg-muted border border-border flex items-center justify-center text-muted-foreground/10 group-hover:text-primary group-hover:border-primary/40 group-hover:rotate-12 transition-all shadow-2xl">
                     <HandHeart size={40} />
                  </div>
               </Link>
            </div>
            ...
            <div className="lg:col-span-8 p-16 lg:p-24 border border-border rounded-[6rem] bg-background/60 shadow-[0_80px_150px_rgba(0,0,0,1)] relative overflow-hidden backdrop-blur-3xl group">
               <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-primary to-transparent shadow-[0_0_20px_hsl(var(--primary))]" />
               ...
               <div className="relative z-10 space-y-20">
                  ...
                  {isSuccess ? (
                    <motion.div initial={{ opacity: 0, scale: 0.9, filter: 'blur(15px)' }} animate={{ opacity: 1, scale: 1, filter: 'blur(0px)' }} className="p-16 lg:p-24 bg-primary/5 border-2 border-primary/30 rounded-[5rem] text-center space-y-12 backdrop-blur-3xl shadow-2xl">
                       <div className="w-32 h-32 bg-primary/10 border-2 border-primary/30 rounded-[3rem] flex items-center justify-center mx-auto shadow-[0_40px_100px_rgba(var(--primary),0.2)] animate-pulse relative">
                          <Activity size={64} className="text-primary" strokeWidth={2.5} />
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                         {['50', '250', '1000', '5000'].map(val => (
                            <button 
                               ...
                               className={`py-12 rounded-[3.5rem] font-black text-4xl italic border-2 transition-all relative overflow-hidden group/btn ${amount === val ? 'bg-primary border-primary text-background shadow-[0_40px_100px_rgba(var(--primary),0.3)]' : 'bg-muted/10 border-border text-muted-foreground/20 hover:border-primary/40 hover:text-foreground'}`}
                            >
                               ${val}
                      ...
                      {/* METHOD TOGGLE */}
                      <div className="flex gap-8 p-4 bg-muted/60 border-2 border-border rounded-[4.5rem] shadow-inner">
                         <button 
                            onClick={() => setMethod('CARD')}
                            className={`flex-1 py-8 rounded-[3.5rem] flex items-center justify-center gap-6 font-black uppercase tracking-[0.6em] text-[12px] transition-all italic shadow-2xl ${method === 'CARD' ? 'bg-white text-background' : 'text-muted-foreground/10 hover:text-muted-foreground/40'}`}
                         >
                            <CreditCard size={24} strokeWidth={2.5} /> Fiat / Credit
                         </button>
                         <button 
                            onClick={() => setMethod('CRYPTO')}
                            className={`flex-1 py-8 rounded-[3.5rem] flex items-center justify-center gap-6 font-black uppercase tracking-[0.6em] text-[12px] transition-all italic shadow-2xl ${method === 'CRYPTO' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground/10 hover:text-muted-foreground/40'}`}
                         >
                      ...
                      <AnimatePresence mode="wait">
                         {method === 'CARD' ? (
                            ...
                            >
                               <div className="space-y-6">
                                  ...
                                  <input 
                                     ...
                                     className="w-full bg-muted/60 border-2 border-border p-10 rounded-[3.5rem] outline-none focus:border-primary/50 focus:bg-primary/5 transition-all font-light italic text-2xl text-foreground placeholder:text-muted-foreground/5 shadow-inner" 
                                  />
                                </div>
                               
                               {clientSecret ? (
                                  <div className="p-12 lg:p-16 bg-background border-4 border-border rounded-[5rem] shadow-[0_60px_150px_rgba(0,0,0,0.8)] backdrop-blur-3xl group/form relative">
                            ...
                            >
                               <div className="p-16 lg:p-24 bg-primary/5 border-2 border-primary/20 rounded-[5rem] flex flex-col items-center text-center space-y-12 relative overflow-hidden group shadow-2xl">
                                  <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-transparent opacity-50" />
                                  <div className="w-40 h-40 md:w-56 md:h-56 bg-white responsive-rounded border-4 border-primary/30 flex items-center justify-center p-6 md:p-8 shadow-2xl group-hover:scale-105 transition-transform duration-1000">
                                     <div className="w-full h-full bg-muted/95 rounded-[2.5rem] flex items-center justify-center shadow-inner">
                                        <Zap size={64} className="text-primary group-hover:rotate-12 transition-transform duration-700" strokeWidth={3} />
                                     </div>
                                  </div>
