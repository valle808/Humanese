  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground font-sans selection:bg-primary/40 selection:text-foreground overflow-x-hidden pb-40">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-20%] right-[-10%] w-[120vw] h-[120vw] bg-primary/5 blur-[350px] rounded-full animate-pulse" />
        <div className="absolute bottom-[-10%] left-[-20%] w-[100vw] h-[100vw] bg-primary/3 blur-[200px] rounded-full" />
      ...
      <main className="relative z-10 max-w-[1700px] mx-auto px-6 md:px-12 lg:px-24 pt-16 md:pt-24 lg:pt-32 space-y-16 md:space-y-32 flex-1 flex flex-col">
        ...
        >
          {[
            ...
            <motion.div key={pillar.id} variants={item} className="responsive-card border-2 border-border responsive-rounded bg-background backdrop-blur-3xl space-y-12 group hover:border-primary/40 transition-all shadow-[0_80px_150px_rgba(0,0,0,1)] relative overflow-hidden flex flex-col">
              ...
              <div className="h-20 w-20 bg-primary/10 border-2 border-primary/30 rounded-[2rem] flex items-center justify-center text-primary shadow-[0_0_40px_rgba(var(--primary),0.2)] relative z-10 group-hover:scale-110 group-hover:bg-primary group-hover:text-background transition-all shrink-0">
        ...
        <motion.section 
          ...
          viewport={{ once: true }}
          transition={{ duration: 1.5, ease: "expoOut" }}
          className="space-y-24 border-t-2 border-border pt-40"
        >
