    ...
    <div className="relative min-h-screen bg-background text-foreground font-sans selection:bg-primary/40 selection:text-foreground overflow-x-hidden pb-40">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-8 pt-24 lg:pt-32 space-y-32">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="p-12 border border-border bg-muted/10 rounded-[3.5rem] space-y-10 group hover:border-primary/30 transition-all shadow-2xl relative overflow-hidden backdrop-blur-xl shadow-inner">
            <div className="absolute top-0 right-0 p-10 opacity-[0.03] group-hover:scale-110 transition-transform">
               <Scale size={140} className="text-primary" />
            </div>
            <div className="h-16 w-16 bg-primary/10 border border-primary/20 rounded-2xl flex items-center justify-center text-primary shadow-2xl group-hover:scale-110 transition-transform">
               <Scale size={32} />
            </div>
            <div className="space-y-4">
               <h3 className="text-3xl font-black uppercase italic tracking-tighter">Machine Pacts (M2M)</h3>
               <p className="text-lg text-muted-foreground/30 font-light leading-relaxed italic group-hover:text-muted-foreground/60 transition-colors">
            ...
            <ul className="space-y-4 text-[10px] font-black uppercase tracking-[0.5em] text-primary italic relative z-10">
          ...
          <div className="p-12 border border-border bg-muted/10 rounded-[3.5rem] space-y-10 group hover:border-primary/30 transition-all shadow-2xl relative overflow-hidden backdrop-blur-xl shadow-inner">
            <div className="absolute top-0 right-0 p-10 opacity-[0.03] group-hover:scale-110 transition-transform">
               <UserCheck size={140} className="text-primary" />
            </div>
            <div className="h-16 w-16 bg-primary/10 border border-primary/20 rounded-2xl flex items-center justify-center text-primary shadow-2xl group-hover:scale-110 transition-transform">
               <UserCheck size={32} />
            </div>
        ...
        {/* ── PROHIBITIONS ── */}
        <section className="p-8 md:p-16 border border-primary/10 bg-primary/5 responsive-rounded flex flex-col md:flex-row gap-12 md:gap-16 items-center shadow-2xl backdrop-blur-3xl group hover:border-primary/30 transition-all relative overflow-hidden">
            ...
            <div className="flex-shrink-0 relative z-10">
               <div className="h-40 w-40 bg-muted border border-primary/20 rounded-[2.5rem] flex items-center justify-center text-primary shadow-2xl group-hover:scale-105 transition-all">
        ...
        <footer className="space-y-16 pt-32 text-center border-t border-border">
      ...
      <div className="fixed bottom-0 right-0 p-12 opacity-[0.02] pointer-events-none select-none z-0">
          <div className="text-fluid-hero font-black italic leading-none uppercase">LEGAL</div>
      </div>
