      ...
      <main className={`relative z-10 w-full max-w-[1700px] mx-auto flex-1 flex flex-col px-8 transition-all duration-1000 ease-out ${results.length > 0 ? 'pt-24 lg:pt-32 pb-40' : 'justify-center items-center h-[calc(100vh-200px)]'}`}>
        ...
        >
          ...
          <input
            ...
            className="w-full bg-[#050505] border-2 border-white/5 responsive-rounded py-8 md:py-12 px-10 md:pl-32 md:pr-32 text-4xl md:text-5xl text-white outline-none focus:border-[#ff6b2b]/40 focus:bg-[#ff6b2b]/5 transition-all duration-700 shadow-[0_40px_100px_rgba(0,0,0,1)] group-hover:border-white/10 placeholder:text-white/5 italic font-light shadow-inner"
          />
          {query && (
            <button 
              type="button" 
