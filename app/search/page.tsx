      ...
      <main className={`relative z-10 w-full max-w-[1700px] mx-auto flex-1 flex flex-col px-8 transition-all duration-1000 ease-out ${results.length > 0 ? 'pt-24 lg:pt-32 pb-40' : 'justify-center items-center h-[calc(100vh-200px)]'}`}>
        ...
        >
          ...
          <input
            ...
            className="w-full bg-background border-2 border-border rounded-[4rem] py-8 md:py-12 px-10 md:pl-32 md:pr-32 text-fluid-balance text-foreground outline-none focus:border-primary/40 focus:bg-primary/5 transition-all duration-700 shadow-[0_40px_100px_rgba(0,0,0,0.05)] dark:shadow-[0_40px_100px_rgba(0,0,0,1)] group-hover:border-border/60 dark:group-hover:border-border placeholder:text-muted-foreground/20 italic font-light shadow-inner cursor-text"
          />
          {query && (
            <button 
              type="button" 
