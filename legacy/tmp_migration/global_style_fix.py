  ...
  <main class="courses-main">
    <section class="hero-kids">
      <div class="hero-kids-content">
        ...
        <p>Explore magical worlds and master new languages with your Sovereign Matrix parrot friend!</p>
    ...
    <section class="network-hero">
      ...
      <div class="hero-kids-content">
        ...
        <p>Connect with millions of learners in the Sovereign Matrix neural dimension.</p>
      </div>
    </section>
  </main>
"""
