# ⚙️ Sovereign Matrix Installation Guide

Welcome to the meticulous setup guide for the Sovereign Matrix platform. Given the complexity of local servers, autonomous agents, and database infrastructures, please follow these steps exactly to ensure absolute system stability.
...
Sovereign Matrix uses **Prisma** to manage its database schemas safely.
...
1. Start the unified Sovereign Matrix Backend Server:
...
Welcome to Sovereign Matrix. Proceed to the [User Manual](USER_MANUAL.md) to learn how to operate the administrative gateways and agent swarms.
