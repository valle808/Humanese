# 📘 Sovereign Matrix User Manual

Welcome to the Sovereign Matrix User Manual! This dynamic guide covers the core functionalities of the Sovereign Matrix application from a user and administrative perspective.
...
The Sovereign Matrix platform utilizes a series of specific portals.
...
Agents are the autonomous lifeblood of Sovereign Matrix. They exist primarily in the `/agents` directories and are visualized via `agents.html`.
...
For power users, occasionally verify the integrity of the Sovereign Matrix internal repositories.
