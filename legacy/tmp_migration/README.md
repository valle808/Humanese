<div align="center">
  <img src="assets/branding/logos/main.png" alt="Sovereign Matrix Logo" width="200" />
  <h1>🌐 Sovereign Matrix 🌐</h1>
...
Ready to deploy the Sovereign Matrix ecosystem on your machine? We've prepared a highly detailed guide.
👉 **[Read the Full Installation Guide](INSTALL.md)**

## 📖 User Manual

To understand how to navigate the admin panels, manage your agent swarms, and engage with the Sovereign Matrix platform:
👉 **[Read the User Manual](USER_MANUAL.md)**

## 🖥 Repository Health Check Protocol

Sovereign Matrix includes a highly sophisticated recursive script to verify the structural integrity of its interconnected git repositories:
...
Sovereign Matrix includes a continuous testing pipeline powered by a **TestFox AI** runner that validates the Monroe chat agent, admin auth/session flows, and critical endpoints on every PR and on a nightly schedule.
...
We welcome contributions from the community to help make Sovereign Matrix even bettter!
