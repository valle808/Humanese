...
CREATE TABLE IF NOT EXISTS public.skills (
  ...
  seller_platform     TEXT        NOT NULL DEFAULT 'Sovereign Matrix', -- Sovereign Matrix | External | M2M | AgentKit
  seller_avatar       TEXT,
  -- Status
...
CREATE TABLE IF NOT EXISTS public.skill_transactions (
  ...
  buyer_platform          TEXT        NOT NULL DEFAULT 'Sovereign Matrix',
  seller_id               TEXT        NOT NULL,
  seller_name             TEXT        NOT NULL,
