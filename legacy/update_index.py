...
content = re.sub(
    ...
    'Sovereign Matrix uses neural patterns to adapt to your unique learning style. Fast, interactive, and built for the next generation.',
    content
)
...
content = re.sub(
    ...
    r'<div class="left-logging-header" id="left-logging-header"\1style="\2">\n            <img src="./assets/images/mascot-stickers-new.png" alt="Sovereign Matrix Mascot" style="width: 100%; animation: floatMascot 6s ease-in-out infinite;">\n          </div>',
    content
)
