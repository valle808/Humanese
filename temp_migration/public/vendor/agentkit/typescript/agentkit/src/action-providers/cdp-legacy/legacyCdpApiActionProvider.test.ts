...
import { LegacyCdpApiActionProvider } from "./legacyCdpApiActionProvider";
...
describe("CDP API Action Provider", () => {
  let actionProvider: LegacyCdpApiActionProvider;
  ...
  beforeEach(() => {
    ...
    actionProvider = new LegacyCdpApiActionProvider();
