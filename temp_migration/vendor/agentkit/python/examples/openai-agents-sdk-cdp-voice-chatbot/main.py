...
class RealtimeApp(App[None]):
    ...
    def __init__(self) -> None:
        ...
        self.pipeline = VoicePipeline(workflow=MyWorkflow(on_start=self._on_transcription))
    ...
    async def on_mount(self) -> None:
        """Start the voice pipeline and send audio from the microphone to the agent."""
    ...
    async def send_mic_audio(self) -> None:
        """Send audio from the microphone to the agent."""
